...
class MainActivity : BaseActivity() {
    ...
    private fun initFragment(savedInstanceState: Bundle?) {
        if (savedInstanceState == null) {
            ...
            mFragments[FIFTH] = DebugFragment.newInstance()
            ...
            mFragments[SECOND] = findFragment(TestFragment::class.java)
            ...
            mFragments[FIFTH] = findFragment(DebugFragment::class.java)
        }
    }
    ...
    private fun initView() {
        ...
        mBottomBar.addItem(BottomBarTab(this, R.drawable.icon_scene_pressed, R.drawable.icon_scene_default))
                ...
                .addItem(BottomBarTab(this, R.mipmap.ic_launcher, R.mipmap.ic_launcher))
